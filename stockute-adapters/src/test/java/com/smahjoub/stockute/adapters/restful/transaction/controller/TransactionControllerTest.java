...
class TransactionControllerTest {
    ...
    void create_ServiceError_ReturnsError() {
        when(createTransactionMapper.toDomain(createTransactionDTO)).thenReturn(domainTransaction);
        when(transactionService.createTransaction(anyString(), anyLong(), any(Transaction.class), anyLong()))
        ...
        verify(transactionService).createTransaction(anyString(), anyLong(), any(Transaction.class), anyLong());
    }
